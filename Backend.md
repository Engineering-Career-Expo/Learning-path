...
3. [pstgres docs](https://www.postgresql.org/docs/9.3/sql.html)
4. [cassandra docs](http://cassandra.apache.org/doc/latest/)
...
1. [Open software docs](https://pusher.com/docs)
2. [Open software docs](https://socket.io/docs/)
3. [Open software docs](https://docs.docker.com/)
